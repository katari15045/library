...
public class MyAlertDialog {
    ...
    public static void build(Object targetActivity){
        Log.d("SAK", "Building alert dialog can't connect...");
        AlertDialog.Builder builder = new AlertDialog.Builder(Global.context);
        View view = ((AppCompatActivity)Global.context).getLayoutInflater().inflate
        ...
        textViewRetry.setOnClickListener(new DialogButListener(Global.context, targetActivity));
