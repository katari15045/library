...
public class OccupancyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(debugTag, "OccupancyActivity::onCreate()");
        captureViews();
    ...
    private void captureViews(){
        drawerLayout = findViewById(R.id.activity_occupancy_drawer_layout);
    }

    @Override
    protected void onResume() {
        super.onResume();
        getSupportActionBar().setTitle(R.string.occupancy);
    }
